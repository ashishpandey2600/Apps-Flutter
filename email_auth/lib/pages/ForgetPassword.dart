                      ...
                      children: [
                        ElevatedButton(
                            ...
                            TextButton(onPressed: ()=>{
                              Navigator.pushAndRemoveUntil(context, PageRouteBuilder(pageBuilder: (context,a,b)=>Login(),transitionDuration:Duration(seconds: 0) ), (route) => false)
                  ...
                  Container(child: Row(mainAxisAlignment: MainAxisAlignment.center,children: [
                    ...
                    TextButton(onPressed: ()=>{
                      Navigator.pushAndRemoveUntil(
                        context, PageRouteBuilder(pageBuilder: (context,a,b)=> Signup(),
